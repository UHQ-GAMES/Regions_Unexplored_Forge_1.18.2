...
public class PalmLeavesPlacer extends TrunkVineDecorator {
	...
	public void place(LevelSimulatedReader levelReader, BiConsumer<BlockPos, BlockState> biConsumer, Random random, List<BlockPos> listBlockPos, List<BlockPos> listBlockPos2) {
		BlockPos newpos = listBlockPos.get(listBlockPos.size()-1);
			...
			biConsumer.accept(y1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			
			if (Feature.isAir(levelReader, fn1)) {
			biConsumer.accept(fn1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fn2)) {
			biConsumer.accept(fn2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fn3)) {
			biConsumer.accept(fn3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fn4)) {
			biConsumer.accept(fn4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			
			if (Feature.isAir(levelReader, fp1)) {
			biConsumer.accept(fp1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fp2)) {
			biConsumer.accept(fp2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fp3)) {
			biConsumer.accept(fp3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, fp4)) {
			biConsumer.accept(fp4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			
			if (Feature.isAir(levelReader, px1)) {
			biConsumer.accept(px1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, px2)) {
			biConsumer.accept(px2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, px3)) {
			biConsumer.accept(px3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, px4)) {
			biConsumer.accept(px4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, px5)) {
			biConsumer.accept(px5, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}

			if (Feature.isAir(levelReader, nx1)) {
			biConsumer.accept(nx1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nx2)) {
			biConsumer.accept(nx2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nx3)) {
			biConsumer.accept(nx3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nx4)) {
			biConsumer.accept(nx4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nx5)) {
			biConsumer.accept(nx5, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}

			if (Feature.isAir(levelReader, pz1)) {
			biConsumer.accept(pz1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, pz2)) {
			biConsumer.accept(pz2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, pz3)) {
			biConsumer.accept(pz3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, pz4)) {
			biConsumer.accept(pz4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, pz5)) {
			biConsumer.accept(pz5, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}

			if (Feature.isAir(levelReader, nz1)) {
			biConsumer.accept(nz1, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nz2)) {
			biConsumer.accept(nz2, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nz3)) {
			biConsumer.accept(nz3, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nz4)) {
			biConsumer.accept(nz4, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
			if (Feature.isAir(levelReader, nz5)) {
			biConsumer.accept(nz5, RegionsUnexploredBlocks.PALM_LEAVES.get().defaultBlockState());
			}
		}
	}
